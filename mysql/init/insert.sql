...
VALUES 
    (1, 259, '4', to_date('2016-01-01', 'RRRR-MM-DD'), to_date('2016-01-03', 'RRRR-MM-DD'), to_date('2016-01-03', 'RRRR-MM-DD'), 1, 2),
    (2, 1212, '4', to_date('2016-01-01', 'RRRR-MM-DD'), to_date('2016-01-04', 'RRRR-MM-DD'), to_date('2016-01-03', 'RRRR-MM-DD'), 2, 6),
    (3, 523, '4', to_date('2016-01-02', 'RRRR-MM-DD'), to_date('2016-01-05', 'RRRR-MM-DD'), to_date('2016-01-03', 'RRRR-MM-DD'), 2, 7),
    (4, 175, '4', to_date('2016-01-03', 'RRRR-MM-DD'), to_date('2016-01-04', 'RRRR-MM-DD'), to_date('2016-01-05', 'RRRR-MM-DD'), 1, 3),
    (5, 1324, '4', to_date('2016-01-03', 'RRRR-MM-DD'), to_date('2016-01-06', 'RRRR-MM-DD'), to_date('2016-01-06', 'RRRR-MM-DD'), 2, 6),
    (6, 94, '4', to_date('2016-01-04', 'RRRR-MM-DD'), to_date('2016-01-07', 'RRRR-MM-DD'), to_date('2016-01-05', 'RRRR-MM-DD'), 2, 6),
    (7, 324, '4', to_date('2016-01-04', 'RRRR-MM-DD'), to_date('2016-01-07', 'RRRR-MM-DD'), to_date('2016-01-05', 'RRRR-MM-DD'), 2, 6),
    (8, 1204, '4', to_date('2016-01-04', 'RRRR-MM-DD'), to_date('2016-01-05', 'RRRR-MM-DD'), to_date('2016-01-05', 'RRRR-MM-DD'), 2, 7),
    (9, 60, '4', to_date('2016-01-05', 'RRRR-MM-DD'), to_date('2016-01-08', 'RRRR-MM-DD'), to_date('2016-01-08', 'RRRR-MM-DD'), 1, 2),
    (10, 442, '4', to_date('2016-01-05', 'RRRR-MM-DD'), to_date('2016-01-06', 'RRRR-MM-DD'), to_date('2016-01-06', 'RRRR-MM-DD'), 2, 6);
